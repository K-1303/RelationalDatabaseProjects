...
--
-- Name: games fk_games_opponent; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: games fk_games_winner; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
